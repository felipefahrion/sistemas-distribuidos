...
p2pPeer.class:			p2pPeerThread.class p2pPeerHeartbeat.class p2pPeerClient.class p2pPeer.java
				@javac p2pPeer.java
...
p2pPeerClient.class:		p2pPeerClient.java
				@javac p2pPeerClient.java
